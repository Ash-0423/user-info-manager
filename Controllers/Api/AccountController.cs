...
public class AccountController(UsersService _userService,
    IConfiguration _configuration,
    MembersDataAccess membersDataAccess,
    UserContactDataAccess userContactDataAccess,
    UserAddressDataAccess userAddressDataAccess) : ControllerBase
{
    /// <summary>
    /// update user
    /// </summary>
    ...
    public IActionResult CreateConnect([FromBody] UserContact model)
    {
        ...
        model.Verified = false;
        userContactDataAccess.AddUserContact(model);
        return Ok();
    }
