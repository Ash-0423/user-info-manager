...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        {
            var connectionString = Configuration.GetConnectionString("DefaultConnection");
            return new AdoNetHelper(connectionString);
        });
        // 添加数据访问类
        services.AddScoped<MembersDataAccess>();
        services.AddScoped<UserContactDataAccess>();
        services.AddScoped<UserAddressDataAccess>();
        services.AddScoped<RelationshipDataAccess>();
        services.AddScoped<LookupsDataAccess>();
